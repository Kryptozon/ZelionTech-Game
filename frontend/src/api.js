...
export const api = {
  ...
  adminUserGameXp: (id, delta) => req(`/admin/users/${id}/game-xp`, { method: 'POST', body: JSON.stringify({ delta }) }),
  adminUserRankingXp: (id, delta) => req(`/admin/users/${id}/ranking-xp`, { method: 'POST', body: JSON.stringify({ delta }) }),
  adminRecalcRankings: () => req('/admin/recalculate-rankings', { method: 'POST' }),
  adminTasks: () => req('/admin/tasks'),
  adminTaskReward: (id, reward) => req(`/admin/tasks/${id}/reward`, { method: 'POST', body: JSON.stringify({ reward }) }),
  adminTaskActive: (id, active) => req(`/admin/tasks/${id}/active`, { method: 'POST', body: JSON.stringify({ active }) }),
